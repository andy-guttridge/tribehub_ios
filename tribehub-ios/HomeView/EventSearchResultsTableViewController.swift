...
class EventSearchResultsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EventSearchResultCell", for: indexPath)
...
extension EventSearchResultsTableViewController: UISearchBarDelegate {
